 ...
 */
angular.module("mayhem", []).factory("$mayhem", ["$q", "$http", "$rootScope", function($q, $http, $rootScope) {
     ...
     * @return   promise
     */
    var mayhem = function(databaseUrl, databaseName) {
    ...
    mayhem.prototype = {
        ...
        get : function(reqUrl){
          return this.makeRequest("GET",this.databaseUrl  + reqUrl + ".json" );
        },

        delete : function(reqUrl){
            return this.makeRequest("DELETE",this.databaseUrl + "/" + reqUrl + ".json" );
        },

        update : function(reqUrl,jsonData){
          return this.makeRequest("PUT",this.databaseUrl + "/" + reqUrl + ".json",null,jsonData);
        },

        create : function(reqUrl,jsonData){
          return this.makeRequest("POST",this.databaseUrl + "/" + reqUrl + ".json",null,jsonData);
        },
