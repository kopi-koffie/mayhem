...
.controller('ScheduleCtrl', ['$scope','$firebase','$uibModal',function($scope,$firebase,$uibModa) {
...
.controller('DashboardCtrl', ['$scope','$firebase','$uibModal',function($scope,$firebase,$uibModa) {
}])
;
